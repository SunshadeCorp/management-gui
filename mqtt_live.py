...
#     nuitka-project: --onefile-tempdir-spec="{PROGRAM_DIR}/.mqtt-live"
...
from ha_discovery import generate_ha_discovery_payload, SensorDef
...
class MqttLiveWindow(Ui_MainWindow):
    ...
    def set_can_ha_discovery(self):
        sensors = [
            SensorDef('limit_max_voltage', state_topic='limits/max_voltage', device_class='voltage', unit='V'),
            SensorDef('limit_min_voltage', state_topic='limits/min_voltage', device_class='voltage', unit='V'),
            SensorDef('limit_max_discharge_current', state_topic='limits/max_discharge_current', device_class='current',
                      unit='A'),
            SensorDef('limit_max_charge_current', state_topic='limits/max_charge_current', device_class='current',
                      unit='A'),

            SensorDef('battery_voltage', state_topic='battery/voltage', device_class='voltage', unit='V',
                      state_class='measurement'),
            SensorDef('battery_current', state_topic='battery/current', device_class='current', unit='A',
                      state_class='measurement'),
            SensorDef('battery_temp', state_topic='battery/temp', device_class='temperature', unit='°C',
                      state_class='measurement'),
            SensorDef('battery_max_cell_temp', state_topic='battery/max_cell_temp', device_class='temperature',
                      unit='°C', state_class='measurement'),
            SensorDef('battery_min_cell_temp', state_topic='battery/min_cell_temp', device_class='temperature',
                      unit='°C', state_class='measurement'),
            SensorDef('battery_soc', state_topic='battery/soc', device_class='battery', unit='%',
                      state_class='measurement'),
            # SensorDef('battery_soh', state_topic='battery/soh', device_class='battery', unit='%'),
            # SensorDef('battery_remaining_capacity_ah', state_topic='battery/remaining_capacity_ah', unit='Ah'),
            # SensorDef('battery_full_capacity_ah', state_topic='battery/full_capacity_ah', unit='Ah'),

            SensorDef('inverter_battery_voltage', state_topic='inverter/battery_voltage', device_class='voltage',
                      unit='V', state_class='measurement'),
            SensorDef('inverter_battery_current', state_topic='inverter/battery_current', device_class='current',
                      unit='A', state_class='measurement'),
            SensorDef('inverter_temperature', state_topic='inverter/temperature', device_class='temperature', unit='°C',
                      state_class='measurement'),
            SensorDef('inverter_soc', state_topic='inverter/soc', device_class='battery', unit='%',
                      state_class='measurement'),
        ]
        payload = generate_ha_discovery_payload(sensors, 'esp32_can', 'ESP32 CAN', 'esp32-byd-sim',
